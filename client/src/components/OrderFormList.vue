<template>
    <div class="form-list">
        ...
        <div class="form-list__body">
            <order-form-list-add @hideForm="toggleShowAddForm" v-if="isAddFormShow" ></order-form-list-add>
            <button @click="toggleShowAddForm" v-else class="form-list__button">Dodaj towar</button>
        </div>
    </div>
</template>
